          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
            <div className="relative" style={{ aspectRatio: "1" }}>
              {portrait.originalImageUrl ? (
                ...
                <div className="w-full h-full flex flex-col items-center justify-center bg-gray-100 dark:bg-gray-800 gap-2 py-6">
                  <span className="text-2xl">🔒</span>
                  <p className="text-xs text-gray-400 text-center">🔒 肖像仅保存在本地设备</p>
                  <button
                    type="button"
                    onClick={handleDownloadPortrait}
                    className="mt-1 px-3 py-1.5 bg-purple-600 hover:bg-purple-700 text-white text-xs rounded-lg flex items-center gap-1 transition-colors"
                  >
