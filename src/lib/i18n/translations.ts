  ...
  "zh-CN": {
    ...
    portraits: {
      ...
      detail: {
        ...
        notCertified: "尚未认证",
        notCertifiedDesc: "在以太坊 Sepolia 上认证此肖像以创建不可变的作者身份证明。你的肖像元数据将存储在 IPFS 上。",
        ...
        certifiedAt: "认证时间",
        // Certification flow
        certifyConfirm: "确定要在以太坊 Sepolia 上认证此肖像吗？这将上传到 IPFS 并铸造链上交易。",
        certifyStepHash: "正在计算图片哈希...",
        certifyStepUploadMeta: "正在上传元数据到 IPFS...",
        certifyStepMint: "正在 Sepolia 铸造（确认钱包）...⌛",
  ...
  "en-US": {
    ...
    portraits: {
      ...
      detail: {
        ...
        notCertifiedDesc: "Certify this portrait on Ethereum Sepolia to create an immutable proof of authorship. Your portrait metadata will be stored on IPFS.",
        ...
        // Certification flow
        certifyConfirm: "Certify this portrait on Ethereum Sepolia? This will upload to IPFS and mint an on-chain transaction.",
